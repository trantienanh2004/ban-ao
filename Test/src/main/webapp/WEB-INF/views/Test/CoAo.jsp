...
<header>
    ...
    <div class="card text-bg-light" style="height: 150px; top:50px; margin-top: -25px ">
        <div class="row" style="padding-left: 50px; padding-top:25px">
            ...
            <div class="col-md-1" >
               <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#addcl">
...
<h2 style="text-align: center; padding-top: 70px">Sản phẩm với thuộc tính kích thước</h2>
...
<h2 style="text-align: center; padding-top: 130px">Sản phẩm với thuộc tính màu sắc</h2>
<div class="card text-bg-light" style="top: 100px; margin-top: -75px">
    <table class="table " style="padding-top:150px">
        <thead>
        <tr>
