...
VALUES ('Thương hiệu A', GETDATE()),
       ('Thương hiệu B', GETDATE());

INSERT INTO CHAT_LIEU (MA_CHAT_LIEU, TEN_CHAT_LIEU, TRANG_THAI, NGAY_TAO)
VALUES ('CL001', 'Chất liệu A', 1, GETDATE()),
       ('CL002', 'Chất liệu B', 0, GETDATE());

INSERT INTO DANH_MUC (TEN_DANH_MUC, TRANG_THAI, NGAY_TAO)
VALUES ('Danh mục A', 1, GETDATE()),
       ('Danh mục B', 0, GETDATE());

 INSERT INTO NHA_SAN_XUAT (MA_NHA_SAN_XUAT, TEN_NHA_SAN_XUAT, TRANG_THAI, NGAY_TAO)
VALUES ('NSX001', 'Nhà sản xuất A', 1, GETDATE()),
       ('NSX002', 'Nhà sản xuất B', 0, GETDATE());

INSERT INTO CO_AO (TEN_CO_AO, TRANG_THAI, NGAY_TAO)
VALUES ('Cỡ áo A', 1, GETDATE()),
       ('Cỡ áo B', 0, GETDATE());
...
VALUES ('SP001', 'Sản phẩm A', 'image1.jpg', GETDATE(), 1, 1, 100, 1, 1, 1),
       ('SP002', 'Sản phẩm B', 'image2.jpg', GETDATE(), 2, 2, 150, 2, 2, 1);
INSERT INTO KICH_THUOC (MA_KICH_THUOC, TEN_KICH_THUOC, TRANG_THAI, NGAY_TAO)
VALUES ('KT001', 'Kích thước A', 1, GETDATE()),
       ('KT002', 'Kích thước B', 0, GETDATE());
INSERT INTO MAU_SAC (MA_MAU_SAC, TEN_MAU_SAC, TRANG_THAI, NGAY_TAO)
VALUES ('MS001', 'Màu sắc A', 1, GETDATE()),
       ('MS002', 'Màu sắc B', 0, GETDATE());
...
VALUES ('image_detail1.jpg', 1, 1, 1, 1, 50, 100000, 'Mô tả sản phẩm chi tiết A', GETDATE(), 1),
       ('image_detail2.jpg', 2, 2, 2, 2, 75, 120000, 'Mô tả sản phẩm chi tiết B', GETDATE(), 1);
...
VALUES ('Nhân viên A', 'NV001', 'staff1', 'password1', 'Nhân viên bán hàng', 1, GETDATE()),
       ('Nhân viên B', 'NV002', 'staff2', 'password2', 'Nhân viên kho', 0, GETDATE());
...
VALUES (1, 1, 2, 100000, GETDATE(), 200000, 'Tiền mặt'),
       (2, 2, 1, 120000, GETDATE(), 120000, 'Chuyển khoản');
INSERT INTO DOI_TRA (ID_KHACH_HANG, LY_DO_DOI, NGAY_DOI_TRA, TRANG_THAI, MO_MA, ID_HOA_DON_CHI_TIET, HINH_THUC_THANH_TOAN)
VALUES (1, 'Lỗi size', GETDATE(), 1, 'Exchange1', 1, 'Tiền mặt'),
       (2, 'Lỗi màu', GETDATE(), 1, 'Exchange2', 2, 'Chuyển khoản');
INSERT INTO SAN_PHAM_LOI (TEN_SAN_PHAM_LOI, MO_MA, ID_HOA_DON_CHI_TIET, SO_LUONG)
VALUES ('Lỗi sản phẩm A', 'Error1', 1, 1),
       ('Lỗi sản phẩm B', 'Error2', 2, 2);
...
VALUES ('VOUCHER001', 'Voucher1', 'Giảm giá 10%', GETDATE(), DATEADD(MONTH, 1, GETDATE()), '10%', 1, 'Áp dụng cho đơn hàng trên 500,000 đồng'),
       ('VOUCHER002', 'Voucher2', 'Giảm giá 20%', GETDATE(), DATEADD(MONTH, 1, GETDATE()), '20%', 1, 'Áp dụng cho đơn hàng trên 1,000,000 đồng
